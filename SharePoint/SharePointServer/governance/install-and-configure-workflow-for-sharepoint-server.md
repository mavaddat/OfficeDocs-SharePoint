...
|**Project Server Workflow 2016** <br/> |Windows Workflow Foundation 4  <br/> |Installs automatically with SharePoint Server; Project Server is activated first, prior to the activation of the SharePoint Server.  <br/> |
